...
using dotnetcourse.Models.Enums;

namespace dotnetcourse.Models.ValueTypes
{
    /// <summary>
                          ...
                          IComparable
    {
        ...
        {
            get { return Currency1.GetValueOrDefault(Currency.FromCurrentCulture()); }
        }

        public Currency? Currency1 => Currency2;

        public Currency? Currency2 => _currency;
        ...
        /// <summary>
        /// Implicitly converts a <see cref="float"/> value to <see cref="Money"/> with no <see cref="Currency"/> value.
        /// </summary>
        /// <param name="value">
        /// The value.
        /// </param>
        ...
        public override int GetHashCode()
        {
            unchecked
            {
                return 397 * _units.GetHashCode() ^ Currency1.GetHashCode();
            }
        }
        ...
        {
            return computeValue().ToString("C", (IFormatProvider)Currency1 ?? NumberFormatInfo.CurrentInfo);
        }

        public string ToString(string format)
        {
            return computeValue().ToString(format, (IFormatProvider)Currency1 ?? NumberFormatInfo.CurrentInfo);
        }
